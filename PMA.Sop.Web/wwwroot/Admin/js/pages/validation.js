    ...
    var defaults = {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "خیلی بلند : حداکثر '" + $this.attr("maxlength") + "' کاراکتر<!-- data-validation-maxlength-message to override -->";
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "خیلی کوتاه : حداقل '" + $this.attr("minlength") + "' کاراکتر<!-- data-validation-minlength-message to override -->";
        ...
        validatorTypes: {
            ...
            required: {
                name: "required",
                init: function ($this, name) {
                    var message = "این مورد اجباری است";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    return {
        ...
        builtInValidators: {
            ...
            required: {
                name: "Required",
                type: "required",
                message: "این مورد اجباری است<!-- data-validator-required-message to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
