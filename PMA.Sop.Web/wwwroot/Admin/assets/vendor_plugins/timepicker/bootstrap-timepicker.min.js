    ...
    i.prototype = {
        ...
        setTime: function (e) {
            ...
            if (this.showMeridian) {
                ...
                if (this.meridian === "صبح" || this.meridian === "a") {
                    this.meridian = "صبح"
                } else if (this.meridian === "عصر" || this.meridian === "p") {
                    this.meridian = "عصر"
                }
                if (this.meridian !== "صبح" && this.meridian !== "عصر") {
                    this.meridian = "صبح"
                }
            } else {
                if (this.hour >= 24) {
        ...
        toggleMeridian: function () {
            this.meridian = this.meridian === "صبح" ? "عصر" : "صبح";
            this.update()
        },
        update: function () {
            this.$element.trigger({
