...
! function (a) {
    ...
    var q = a.fn.datepicker.dates = {
            en: {
                ...
                months: ["ژانویه", "فوریه", "مارس", "آپریل", "مه", "ژوئن", "جولای", "آگوست", "سپتامبر", "اکتبر", "نوامبر", "December"],
                monthsShort: ["ژانویه", "فوریه", "مارس", "آپریل", "مه", "ژوئن", "جولای", "آگوست", "سپتامبر", "اکتبر", "نوامبر", "دسامبر"],
                today: "امروز",
                clear: "پاک کردن",
                titleFormat: "MM yyyy"
            }
