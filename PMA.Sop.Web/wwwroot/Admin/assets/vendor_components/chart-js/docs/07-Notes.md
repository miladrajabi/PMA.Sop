...
- When declaring fonts, the library explorercanvas requires the font name to be in single quotes inside the string. For example, instead of your scaleFontFamily property being simply "iransans", explorercanvas support, use "'iransans'" instead. Chart.js does this for default values.
